...
public class Produto {
    ...
    public void setVendidoIndividualmente(boolean vendidoIndividualmente) { this.vendidoIndividualmente = vendidoIndividualmente; }
    ...
    public void setMateriaPrima(boolean materiaPrima) { isMateriaPrima = materiaPrima; }
    @JsonProperty("isKit")
